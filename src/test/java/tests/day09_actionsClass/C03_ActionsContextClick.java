...
public class C03_ActionsContextClick extends TestBase {
    ...
    public void test01(){
        ...
        //   link tıkladığında yeni bir tab açılıyor,
        //   o tab'a geçmek için C01'deki methodu'kullanalım

        ReusableMethods.titleWindowDegistir("Elemental Selenium | Elemental Selenium",driver);
        ...
        Assert.assertEquals(expectedYaziElementi,actualYazi);
